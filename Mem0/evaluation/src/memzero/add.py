...
class MemoryADD:
    ...
    def process_conversation(self, item, idx, show_progress: bool = False, total_samples: int | None = None):
        ...
        session_iter = iter_sessions() if not show_progress else tqdm(list(iter_sessions()), leave=False)

        for key in session_iter:
